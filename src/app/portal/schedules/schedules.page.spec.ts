...
describe('SchedulesPage', () => {
  ...
  async function build(state: Resource<readonly ITask[]>): Promise<void> {
    const streams = {
    ...
    streams.schedules$ = new BehaviorSubject(state) as never;

    await TestBed.configureTestingModule({
      imports: [SchedulesPage, TranslateModule.forRoot()],
      providers: [
        provideHttpClient(),
  ...
  it('shows skeletons while loading', async () => {
    await build(LOADING as Resource<readonly ITask[]>);
