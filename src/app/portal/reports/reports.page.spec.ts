...
describe('ReportsPage', () => {
  ...
  async function build(state: Resource<readonly IReport[]>): Promise<void> {
    const streams = {
    ...
    streams.reports$ = new BehaviorSubject(state) as never;
  ...
  it('shows skeletons while loading', async () => {
    await build(LOADING as Resource<readonly IReport[]>);
