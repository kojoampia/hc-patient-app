...
describe('MedicationsPage', () => {
  ...
  async function build(state: Resource<readonly IMedication[]>): Promise<void> {
    const streams = {
    ...
    streams.medications$ = new BehaviorSubject(state) as never;

    await TestBed.configureTestingModule({
      imports: [MedicationsPage, TranslateModule.forRoot()],
      providers: [
        provideHttpClient(),
  ...
  it('shows skeletons while loading', async () => {
    await build(LOADING as Resource<readonly IMedication[]>);
